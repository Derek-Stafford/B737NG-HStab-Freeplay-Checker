*Note: Calculator 1 just displays only the messages and the inputs/outputs, while Calculator 2 not only displays the same thing but formatted to display it in tables.*
Description:
